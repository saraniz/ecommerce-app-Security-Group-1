   ...
   <div class="container pt-5 mt-4">
      <main class="content col-lg-12 col-md-12 col-sm-12 Content">
         ...
         <div class="Search card p-3 my-3">
            <form class="form-inline d-flex gap-2" action="{{ route('orders.order_search') }}" method="GET">
               ...
               <button class="btn btn-primary" type="submit" action="{{route('orders.order_view')}}">Reset</button>
            </form>
         ...
         <table class="table">
            ...
            <tbody>
               <tr>
                  ...
                  <td>{{$post->shippping_address}}</td>
                  <td>{{$post->created_at}}</td>
                  <td class="action-btns">
                     <button class="btn btn-sm me-1 btn-info text-white"><i class="bi bi-eye"></i></button>
                     
                     <a href="{{ route('edito_post.{id}', $post->id) }}" method="POST" class="btn btn-sm me-1 btn-warning text-white">
                      <i class="bi bi-pencil-square"></i>
                     </a>
                     <a href="{{ route('deleteo_post.{id}', $post->id) }}" method="POST" class="btn btn-sm me-1 btn-danger">
