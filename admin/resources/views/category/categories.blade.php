    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="mainNavbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('orders.order_view')}}">Orders</a>
          </li>
   ...
   <div class="container pt-5 mt-4">
      <main class="content col-lg-12 col-md-12 col-sm-12 Content">
         ...
         <div class="Search card p-3 my-3">
            <form class="form-inline d-flex gap-2" action="{{ route('categories.category_search') }}" method="GET">
               ...
               <button class="btn btn-primary" type="submit" action="{{route('categories.category_view')}}">Reset</button>
            </form>
         </div>
            ...
            <tbody>
               <tr>
                  ...
                  <td class="action-btns">
                     ...
                     <a href="{{ route('editc_post.{id}', $post->id) }}" method="POST" class="btn btn-sm me-1 btn-warning text-white">
                      <i class="bi bi-pencil-square"></i>
                     </a>
                     <a href="{{ route('deletec_post.{id}', $post->id) }}" method="POST" class="btn btn-sm me-1 btn-danger">
