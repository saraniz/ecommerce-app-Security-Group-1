   ...
   <div class="container pt-5 mt-4">
      <main class="content col-lg-12 col-md-12 col-sm-12 Content">
         ...
         <div class="Search card p-3 my-3">
            <form class="form-inline d-flex gap-2" action="{{ route('users.user_search') }}" method="GET">
               <input class="form-control mr-sm-2" type="search" name="search" placeholder="Enter Customer ID"
                  aria-label="Search">
               <button class="btn my-2 my-sm-0 SButton" type="submit">Search</button>
               <button class="btn btn-primary" type="submit" action="{{route('user.user_view')}}">Reset</button>
            </form>
         </div>
            ...
            <tbody>
               <tr>
                  ...
                  <td class="action-btns">
                    ...
                    <a href="{{ route('editu_post.{id}', $post->id) }}" method="POST" class="btn btn-sm me-1 btn-warning text-white">
                      <i class="bi bi-pencil-square"></i>
                     </a>
                     <a href="{{ route('deleteu_post.{id}', $post->id) }}" method="POST" class="btn btn-sm me-1 btn-danger">
